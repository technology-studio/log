...
export const getDefaultLevel = (): Level => (
  configManager.config.defaultLevelForNodeEnvironmentMap != null
    ? configManager.config.defaultLevelForNodeEnvironmentMap[process.env.NODE_ENV != null && process.env.NODE_ENV !== '' ? process.env.NODE_ENV : 'development']
